...
table_name = 'TestEncryptionTable'
aws_cmk_id = 'arn:aws:kms:us-west-2:176385768664:key/3a90a5d2-2ba8-4942-b9df-9a27ff7bf412'
meta_table_name = 'TestEncryptionMetaDataTable'
material_name = 'MaterialName'

encrypted_item = encrypt_item(table_name, aws_cmk_id, meta_table_name, material_name)
